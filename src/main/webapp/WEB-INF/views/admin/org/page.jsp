                        ...
                        <div class="portlet-title">
                            <div class="caption caption-md">
                                <i class="icon-bar-chart theme-font hide"></i> <span
                                    class="caption-subject theme-font bold uppercase">组织机构管理</span>
                            ...
                            <div class="note note-info">
                                <div class="controls">
                                    <div class="success-toggle-button popovers"
                                         ...
                                         data-placement="right" data-content="开启拖拽功能，通过拖拽调整组织机构结构"
...
<div id="context-menu">
    <ul class="dropdown-menu">
        <li class="nav-header" id="m_add" onclick="addOrg();"><a>增加子级组织机构</a>
        </li>
        <li class="nav-header" id="m_addroot" onclick="addTopOrg();"><a>增加顶级组织机构</a>
        </li>
        <li class="nav-header" id="m_del" onclick="deleteOrg();"><a>删除组织机构</a>
        </li>
        <li class="nav-header" id="m_edit" onclick="editOrg();"><a>编辑组织机构</a>
        </li>
    </ul>
</div>
